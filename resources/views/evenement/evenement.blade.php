...
<div class="bloc-left bloc-1">
  <div class="bloc-txt-left">
    ...
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia amet cumque rem corporis odit illum sint
      ...
      voluptate voluptatum aspernatur, odit repellat porro fugit in dolor, tempora atque necessitatibus quibusdam et
      facilis libero delectus fugiat hic! Perferendis, error!</p>
    <button id="btn-hover" class="btn-bloc-left" type="button">En savoir plus</button>
  </div>
  <img src="../img/img-1.jpg" alt="couloir d'un temple de kyoto">
</div>
...
<div class="bloc-2">
  ...
  <img src="../img/img-1.jpg" alt="un château à Kyoto">
</div>
...
<div class="bloc-left bloc-3">
  ...
  <img src="../img/img-1.jpg" alt="une geisha">
</div>
